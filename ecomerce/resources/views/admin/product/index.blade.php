...
<div class="container text-center">
	<div class="page-header">
		<h1>
			...
			</i>PRODUCTOS <a href="{{ route('admin.product.create') }}" class="btn btn-warning"><i class="fa fa-plus-circle"></i> Producto</a>
		</h1>
	</div>
	<div class="page">
				...
				<tbody>
					@foreach($products as $product)
						<tr>
							...
							{!! Form::close() !!}
							<td><img src="productos/{{ $product->image}}"width="40px"  alt=""></td>
							<td>{{ $product->name }}</td>
